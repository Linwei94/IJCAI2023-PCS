...
if __name__ == "__main__":
    ...
    for i in range(100):
        combination = [random.randint(0,349), random.randint(0,349), random.randint(0,349), random.randint(0,349), random.randint(0,349)]
        ...
        print("-" * 50, "{}   TRAIN {} EPOCH   LR{}".format(combination, 1, args.lr),  "-" * 50)

        train_loss = train_single_epoch(1,
                                        net,
                                        train_loader,
                                        optimizer,
                                        device)
