...
import os
import models
import datautils as datutils
import argparse
import trainutils as trainutil
...
parser.add_argument("--datadir", type=str, help="Path to dataset", default='/data')
parser.add_argument("--nmodel", type=int, help="How many models to train (Deep Ensemble)", default=5)
...
parser.add_argument("--epoch", type=int, help="Number of epochs to train", default='350')
parser.add_argument("--max_lr", type=float, help="Maximum learning rate during LR scheduling (OneCycleLR)")
parser.add_argument("--bsize", type=int, help="Batch size", default=128)
